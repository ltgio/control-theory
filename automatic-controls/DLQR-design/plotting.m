...
figure(4)
subplot(2,2,1)
plot(time,rad2deg(sim_Inputs(:,2)),'LineWidth',2)
title('Elevator');
xlabel('Time');
...
subplot(2,2,2)
plot(time,rad2deg(sim_Inputs(:,3)),'LineWidth',2)
title('Ailerons');
xlabel('Time');
...
subplot(2,2,3)
plot(time,rad2deg(sim_Inputs(:,4)),'LineWidth',2)
title('Rudder');
xlabel('Time');
...
subplot(2,2,4)
plot(time,sim_Inputs(:,5),'LineWidth',2)
title('Thrust');
xlabel('Time');
