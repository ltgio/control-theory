  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==1) {
    c1_Chua_MPC_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
       ...
       case 1:
        {
          ...
          sf_c1_Chua_MPC_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2959678813U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2520992292U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1687404876U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3684771157U);
  }
     ...
     case 1:
      {
        if (strcmp(aiChksum, "Ww0ayGEvKowCrF7f2mfNP") == 0) {
          extern mxArray *sf_c1_Chua_MPC_get_autoinheritance_info(void);
          plhs[0] = sf_c1_Chua_MPC_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        extern const mxArray *sf_c1_Chua_MPC_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c1_Chua_MPC_get_eml_resolved_functions_info();
     ...
     case 1:
      {
        if (strcmp(tpChksum, "KN1LlbzORKUw2asDPd0DbH") == 0) {
          extern mxArray *sf_c1_Chua_MPC_third_party_uses_info(void);
          plhs[0] = sf_c1_Chua_MPC_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "KN1LlbzORKUw2asDPd0DbH") == 0) {
          extern mxArray *sf_c1_Chua_MPC_jit_fallback_info(void);
          plhs[0] = sf_c1_Chua_MPC_jit_fallback_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "KN1LlbzORKUw2asDPd0DbH") == 0) {
          extern mxArray *sf_c1_Chua_MPC_updateBuildInfo_args_info(void);
          plhs[0] = sf_c1_Chua_MPC_updateBuildInfo_args_info();
          break;
        }
      }
  ...
  const mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   case 1:
    {
      if (strcmp(tpChksum, "KN1LlbzORKUw2asDPd0DbH") == 0) {
        extern mxArray *sf_c1_Chua_MPC_get_post_codegen_info(void);
        plhs[0] = sf_c1_Chua_MPC_get_post_codegen_info();
        return;
      }
    }
    break;
