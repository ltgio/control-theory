...
subplot(3,3,7);plot(t_rk4(1:end-1),u(1,:),'m','LineWidth',2);hold on;
               legend('ux');grid on;
subplot(3,3,8);plot(t_rk4(1:end-1),u(2,:),'m','LineWidth',2);hold on;
               legend('uy');grid on;
subplot(3,3,9);plot(t_rk4(1:end-1),u(3,:),'m','LineWidth',2);hold on;
               legend('uz');grid on;
